...
public class UI : MonoBehaviour
{
    ...
    public void MenuButtonSystem()
    {
        ...
        UIManager.Instance.creditButton.GetComponent<RectTransform>().DOAnchorPosX(75, _timer);
        UIManager.Instance.shopButton.GetComponent<RectTransform>().DOAnchorPosX(225, _timer);
    }
